export default function Toast(t = "This is a Toast.", e, o) {
    ...
    head = document.head || document.getElementsByTagName("head")[0], style = document.createElement("style"), n = document.createElement("div"); head.appendChild(style), style.type = "text/css", style.styleSheet ? style.styleSheet.cssText = a : style.appendChild(document.createTextNode(a));
    n.setAttribute("id", "toast"), n.classList.add("active"), document.body.appendChild(n);
